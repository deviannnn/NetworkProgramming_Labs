...
public class UDPCalculatorServer extends javax.swing.JFrame {
            ...
            Thread receiverThread = new Thread(() -> {
                try {
                    ...
                    while (!msgIn.equals("exit")) {
                        ...
                        msgIn = new String(packet.getData(), 0, packet.getLength(), "UTF-8");
                        ...
                        byte[] responseData = result.getBytes("UTF-8");
                        DatagramPacket responsePacket = new DatagramPacket(responseData, responseData.length, packet.getAddress(), packet.getPort());
                        server.send(responsePacket);
                        contentArea.append(packet.getAddress() + " at port " + packet.getPort() + " says: " + msgIn + "\n");
                    }
