...
public class DaytimeClient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        textFieldHost.setText("time.nist.gov");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            textAreaResult.setText("It is " + timeString + " at " + host);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DaytimeClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
