...
public class LocalPortScanner extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGap(32, 32, 32)
                                    .addComponent(endPortTbox, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                .addGap(36, 36, 36))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (int port = startPort; port <= endPort; port++) {
            try {
                new ServerSocket(port).close(); // Attempt to open and immediately close the socket
            } catch (IOException ex) {
                result += "There is a server on port " + port + " of localhost\n";
