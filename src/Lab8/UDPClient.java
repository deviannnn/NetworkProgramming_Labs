...
public class UDPClient extends javax.swing.JFrame {
    ...
    public UDPClient(boolean uppercase) {
        initComponents();
    ...
    private void initComponents() {
        ...
        dataArea.setRows(5);
        jScrollPane3.setViewportView(dataArea);
    ...
    private void startBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startBtnActionPerformed
        ...
        try {
                ...
                Thread responseListenerThread = new Thread(() -> {
                    try {
                        ...
                        while (true) {
                            ...
                            contentArea.append("Server response: " + response + "\n");
                        }
            ...
            isConnected = true;
            contentArea.setText("Client is ready to send data...\n");
    ...
    private void sendBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendBtnActionPerformed
        // TODO add your handling code here:
        String dataString = dataArea.getText().trim();
        ...
        try {
            ...
            contentArea.append("Client: " + dataString + "\n");
