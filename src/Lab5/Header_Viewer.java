...
public class Header_Viewer extends javax.swing.JFrame {

    /**
     * Creates new form INetAddress_GetByName
     */
    public Header_Viewer() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Header_Viewer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
