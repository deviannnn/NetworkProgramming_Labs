...
public class Reading_Data_from_Server extends javax.swing.JFrame {

    /**
     * Creates new form INetAddress_GetByName
     */
    public Reading_Data_from_Server() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Reading Data from Server");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String sourceViewer = "";
            try (OutputStream os = new FileOutputStream("output.htm")) {
                int c;
                while ((c = r.read()) != -1) {
                    sourceViewer += (char) c;
                    os.write((char) c);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reading_Data_from_Server.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
