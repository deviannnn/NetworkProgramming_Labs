...
public class Encoding_Aware_Source_Viewer extends javax.swing.JFrame {

    /**
     * Creates new form INetAddress_GetByName
     */
    public Encoding_Aware_Source_Viewer() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Encoding Aware Source Viewer");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Encoding_Aware_Source_Viewer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
