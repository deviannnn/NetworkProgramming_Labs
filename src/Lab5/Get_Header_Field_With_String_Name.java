...
public class Get_Header_Field_With_String_Name extends javax.swing.JFrame {

    /**
     * Creates new form INetAddress_GetByName
     */
    public Get_Header_Field_With_String_Name() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Get Header Field With String Name");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            headerViewer += "* content-type: " + uc.getHeaderField("content-type") + "\n";
            headerViewer += "* content-encoding: " + uc.getHeaderField("content-encoding") + "\n";
            headerViewer += "* Date: " + uc.getHeaderField("date") + "\n";
            headerViewer += "* Expires: " + uc.getHeaderField("expires") + "\n";
            headerViewer += "* Content-length: " + uc.getHeaderField("content-length") + "\n";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Get_Header_Field_With_String_Name.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
