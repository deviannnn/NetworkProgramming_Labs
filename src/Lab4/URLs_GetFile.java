...
public class URLs_GetFile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("URLs GetFile");
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        textFieldInput.setText("http://www.ncsa.uiuc.edu/html-primer.html");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            textAreaResult.setText(url.getFile());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(URLs_GetFile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
