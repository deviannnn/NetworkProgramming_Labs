...
public class URLs_GetRef extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("URLs GetRef");
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        textFieldInput.setText("http://www.ibiblio.org/javafaq/javafaq.html#xtocid1902914");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            textAreaResult.setText(url.getRef());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(URLs_GetRef.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
