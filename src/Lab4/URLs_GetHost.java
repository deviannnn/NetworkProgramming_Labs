...
public class URLs_GetHost extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            textAreaResult.setText(url.getHost());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(URLs_GetHost.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
