...
public class URLs_GetProtocol extends javax.swing.JFrame {

    /**
     * Creates new form INetAddress_GetByName
     */
    public URLs_GetProtocol() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            textAreaResult.setText(url.getProtocol());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(URLs_GetProtocol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
