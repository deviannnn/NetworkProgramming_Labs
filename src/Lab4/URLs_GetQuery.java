...
public class URLs_GetQuery extends javax.swing.JFrame {

    /**
     * Creates new form INetAddress_GetByName
     */
    public URLs_GetQuery() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("URLs GetQuery");
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        textFieldInput.setText("http://www.ibiblio.org/nywc/compositions.phtml?category=Piano");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            textAreaResult.setText(url.getQuery());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(URLs_GetQuery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
