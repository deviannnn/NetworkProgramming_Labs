...
public class URLs_GetPort extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("URLs GetPort");
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        textFieldInput.setText("http://www.userfriendly.org:80/");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            textAreaResult.setText("" + url.getPort());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(URLs_GetPort.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
