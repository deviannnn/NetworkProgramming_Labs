...
public class URLs_GetPath extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("URLs GetPath");
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        textFieldInput.setText("http://www.ncsa.uiuc.edu/demoweb/html-primer.html");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            textAreaResult.setText(url.getPath());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(URLs_GetPath.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
