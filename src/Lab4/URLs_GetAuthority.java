...
public class URLs_GetAuthority extends javax.swing.JFrame {

    /**
     * Creates new form INetAddress_GetByName
     */
    public URLs_GetAuthority() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("URLs GetAuthority");
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        textFieldInput.setText("ftp://mp3:mp3@138.247.121.61:21000/c%3a/");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            textAreaResult.setText(url.getAuthority());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(URLs_GetAuthority.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
