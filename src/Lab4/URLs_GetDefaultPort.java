...
public class URLs_GetDefaultPort extends javax.swing.JFrame {

    /**
     * Creates new form INetAddress_GetByName
     */
    public URLs_GetDefaultPort() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("URLs GetDefaultPort");
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        textFieldInput.setText("http://www.userfriendly.org/");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            textAreaResult.setText("" + url.getDefaultPort());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(URLs_GetDefaultPort.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
