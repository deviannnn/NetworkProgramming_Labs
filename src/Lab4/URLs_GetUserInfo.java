...
public class URLs_GetUserInfo extends javax.swing.JFrame {

    /**
     * Creates new form INetAddress_GetByName
     */
    public URLs_GetUserInfo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("URLs GetUserInfo");
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        textFieldInput.setText("http://elharo@java.oreilly.com/");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            textAreaResult.setText(url.getUserInfo());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(URLs_GetUserInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
